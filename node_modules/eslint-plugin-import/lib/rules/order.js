...
function computeRank(context, ranks, importEntry, excludedImportTypes) {
  var impType = void 0;
  var rank = void 0;
  console.error("importEntry.type",importEntry.type)
  console.error("importEntry.node.importKind",importEntry.node.importKind)
  if (importEntry.type === 'import:object') {
    impType = 'object';
  } else if (importEntry.node.importKind === 'type' && ranks.omittedTypes.indexOf('type') === -1) {
    impType = 'type';
  } else {
    console.error("else case", (0, _importType2['default']))
    impType = (0, _importType2['default'])(importEntry.value, context);
  }
  console.error("impType",impType)
...
function makeNewlinesBetweenReport(context, imported, newlinesBetweenImports) {
  ...
  imported.forEach((i,index) => console.error(index,":",JSON.stringify(i.displayName),"|",JSON.stringify(i.type),"|",JSON.stringify(i.rank)))
...
module.exports = {
  ...
  create: function () {function importOrderRule(context) {
      ...
      try {var _convertPathGroupsFor =
        ...
        console.error(JSON.stringify(ranks))
      } catch (error) {
      ...
      return {
        ImportDeclaration: function () {function handleImports(node) {
            ...
            if (node.specifiers.length || options.warnOnUnassignedImports) {
              ...
              console.error("ImportDeclaration **",name,"**")
              registerNode(
              context,
              {
                node: node,
