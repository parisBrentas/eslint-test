...
function tsConfigLoader(_a) {
    ...
    console.log("tsConfigLoader", { getEnv, cwd, loadSync, TS_NODE_PROJECT,
        TS_NODE_BASEURL, loadResult})
    return loadResult;
}
exports.tsConfigLoader = tsConfigLoader;
function loadSyncDefault(cwd, filename, baseUrl) {
    console.log("loadSyncDefault", {cwd, filename, baseUrl})
...
function walkForTsConfig(directory, existsSync) {
    ...
    console.log("walkForTsConfig", {configPath})
